...
\inputcode{c++}{sections/a1_test.cpp}{Sort algorithms}{1}
\inputcode{python}{sections/test.py}{Test case generator}{2}
\inputcode{bash}{sections/test.sh}{Cases runner}{3}
\inputcode{python}{sections/plot.py}{Plotting program}{4}